...
@section('content')
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <a href="{{ route('admin.member.manage') }}">Operator</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
        ...
        <div class="col-md-6 ">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    {!! Form::open(['route' => isset($update) ? ['admin.member.update', $model->id] : 'admin.member.store', 'files' => true]) !!}
                    <div class="form-body">
                        @if (count($errors) > 0)
                        ...
                        <div class="form-group form-md-line-input {{ $errors->has('isActive') ? ' has-error' : '' }}">
                            {!! Form::select('isActive', ['1'=>'Active','0'=>'Suspend'], $model->isActive,['id'=>'status','placeholder'=>'','class'=>'form-control', 'required']) !!}
